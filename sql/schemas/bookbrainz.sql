...
CREATE TABLE bookbrainz.editor (
	...
	metabrainz_oauth_access_token TEXT,
	metabrainz_oauth_refresh_token TEXT,
...
-- Used by `get_authors_for_artist` and `get_literary_works_for_work` in CritiqueBrainz.
CREATE INDEX identifier_set__identifier_identifier_id_set_id_idx ON bookbrainz.identifier_set__identifier (identifier_id, set_id);
