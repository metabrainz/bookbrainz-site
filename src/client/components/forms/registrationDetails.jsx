	...
	render() {
		...
		return (
			<div>
				...
				<div>
					Great! You successfully logged in to MusicBrainz and are now
					just one step away from becoming a BookBrainz editor. The
					following form allows you to specify additional information
					that will let other users know a little bit more about you.
					When you're done, just click the green button at the bottom
					of the page.
				</div>
				<div className="row">
					{loadingComponent}
					<div className="col-md-6 col-md-offset-3">
						...
						>
							<p>
								Firstly, please check that your display name is
								correct. This is the name that other editors
								will get to know you by.
							</p>
							<Input
							...
							/>
							<p>
								And, optionally, set a gender and birthday that
