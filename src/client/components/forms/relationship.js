...
/**
 * Checks if the relationship is new by checking that the fields weren't set when the form was loaded
...
/**
 * This class is a subclass of ReactComponent, which allows the user to create and edit a relationship.
*/
class RelationshipEditor extends React.Component {
/**
* This is a constructor.
* It binds the event handler functions defined in the class to the class instance.
...
/**
* Creates an array of all of the information for all relationships present on the form.
...
and adds additional information derived from the state that is used internally.
* @returns {integer[]} updatedRelationships - New list of relationships on the form.
*/
getInternalValue() {
...
/**
* Swaps the source and the target of a specified row of updated relationships.
...
* @param {integer[]} updatedRelationships - Relationships with correct changed and valid booleans.
* @param {integer} changedRowIndex - Row index which has been recently changed.
* @returns {integer} rowsSpawned - Total number of rows since the form was loaded.
*/
...
/**
* This takes in a row index and checks if the row has been added since the form was loaded.
* If the row was part of the selection, then the number of selected rows is decremented
...
/**
* Gets the most current information about relationships in the form, and saves it in the form state,
 to update the state following a change and propagate the change to the displayed UI.
* @param {integer} changedRowIndex - Row index which has been recently changed.
*/
...
* Creates a SUBMIT button to submit
new relationships
