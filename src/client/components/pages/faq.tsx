	...
	return (
		<Card>
			...
			<Card.Body>
				<ListGroup>
					<ListGroup.Item>
						<h4><b>{translate('staticPages.faq.q1._self')}</b></h4>
						...
						<ol>
							...
							<li>{translate('staticPages.faq.q1.step2Pre')}{genEntityIconHTMLElement('Work')}{translate('staticPages.faq.q1.step2Post')}</li>
							<li>
					...
					<ListGroup.Item>
						<h4><b>{translate('staticPages.faq.q2._self')}</b></h4>
						<ul>
					...
					<ListGroup.Item>
						<h4><b>{translate('staticPages.faq.q3._self')}</b></h4>
						<ul>
					...
					<ListGroup.Item>
						<h4><b>{translate('staticPages.faq.q4._self')}</b></h4>
