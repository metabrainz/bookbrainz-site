    ...
    return (
      <div>
        ...
        <p>The BookBrainz core data is licensed under the&nbsp;
          ...
          </a> license. The core data includes the following information:
        </p>

        <ul>
          <li>
            <b>Creator</b>&nbsp;
            BBID, aliases, type, begin and end dates, gender and disambiguation comment
          </li>
          <li>
            <b>Publication</b>&nbsp;
          ...
          <li>
            <b>Edition</b>&nbsp;
            BBID, aliases, begin and end dates, language, status and disambiguation comment
          </li>
          <li>
            <b>Publisher</b>&nbsp;
            BBID, aliases, type, begin and end dates and disambiguation comment
          </li>
          <li>
            <b>Work</b>&nbsp;
        ...
        <p>
          ...
          </a> license. If you have any queries about licensing of the public
          data, please ask for clarification. Please see the links below for
          more details about CC0 and CC BY-SA.
        </p>
