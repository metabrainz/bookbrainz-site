			...
			rankUpdate = (
				...
				>
					<CardDeck className="mb-3">
						<DragAndDrop
							initialAchievement={this.currAchievement.model[0]?.achievement}
							name="rank1"
						/>
						<DragAndDrop
							initialAchievement={this.currAchievement.model[1]?.achievement}
							name="rank2"
						/>
						<DragAndDrop
							initialAchievement={this.currAchievement.model[2]?.achievement}
							name="rank3"
						/>
					</CardDeck>
