...
router.get(
	...
	middleware.loadEditionStatuses,
	middleware.loadEditionFormats,
...
function editionToFormState(edition) {
	...
	const physicalVisible = !(
		_.isNull(edition.depth) &&
		_.isNull(edition.height) &&
		_.isNull(edition.pages) &&
		_.isNull(edition.weight) &&
	...
	const publisher =
		edition.publisherSet &&
		(_.isEmpty(edition.publisherSet.publishers)
			? null
			: utils.entityToOption(edition.publisherSet.publishers[0]));
